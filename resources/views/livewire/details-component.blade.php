                ...
                <div class="wrap-product-detail">
                        ...
                        <div class="product-gallery">
                          <ul class="slides">
                            ...
                            <li data-thumb="{{asset('frontend')}}/assets/images/products/{{$product->image}}">
                                <img src="{{asset('frontend')}}/assets/images/products/{{$product->image}}" alt="{{$product->name}}" />
                            </li>
                    ...
                    <div class="detail-info">
                        ...
                        <div class="wrap-price">
                            <span class="product-price  fa-2x">{{$product->sale_price}} Taka</span>
                            <del><p class="product-price">{{$product->regular_price}} Taka</p></del>
                        </div>
                      @else
                      <div class="wrap-price">
                        <span class="product-price">{{$product->regular_price}} Taka</span>
                    </div>
                      @endif
                                ...
                                <div class="product product-widget-style">
                                    <div class="thumbnnail">
                                        <a href="{{route('product.details',['slug'=>$p_product->slug])}}" title="{{$p_product->name}}">
                                            <figure><img src="{{asset('frontend')}}/assets/images/products/{{$p_product->image}}" alt=""></figure>
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <a href="#" class="product-name"><span>{{$p_product->name}}</span></a>
                                        <div class="wrap-price"><span class="product-price">{{$p_product->regular_price}} Taka</span></div>
                                    </div>
                                </div>
                            </li>
                            @endforeach
                            ...
                            <div class="product product-style-2 equal-elem ">
                                <div class="product-thumnail">
                                    <a href="{{route('product.details',['slug'=>$r_product->slug])}}" title="{{$r_product->name}}">
                                        <figure><img src="{{asset('frontend')}}/assets/images/products/{{$r_product->image}}" width="214" height="214" alt="{{$r_product->name}}"></figure>
                                    </a>
